...
7) Clone the Bitseal-Tests Github repository to your system: git clone https://github.com/JonathanCoe/bitseal-tests.git

8) Import bitseal-tests into Eclipse using the menu option File...Import...Import existing Android code
...
10) Bitseal-Tests should now be ready to be built! In Eclipse, go to "Project....Build project"

12) The file bitseal-tests.apk should now be created in the /bin folder of the Eclipse project. 
